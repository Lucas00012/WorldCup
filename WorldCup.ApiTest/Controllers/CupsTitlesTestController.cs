...
namespace WorldCup.WebUI.Controllers
{
    ...
    public class CupsTitlesTestController : ControllerBase
    {
        private readonly ILogger<CupsTitlesTestController> _logger;
        private readonly ICupTitleService _cupTitleService;
        public CupsTitlesTestController(ILogger<CupsTitlesTestController> logger
